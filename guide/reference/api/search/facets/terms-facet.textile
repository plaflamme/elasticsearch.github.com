...
| @field@ | The field to use to extract terms from | _string_ | Yes (1) |
| @size@ | The maximum number of most frequent terms to return | _int_ | No (0..1). Default is XX. |
| @order@ | Allow to control the ordering of the terms facets | _string_ one if @count@, @term@, @reverse_count@ @reverse_term@ | No (0..1). The default is @count@ |
...
| @regex@ | A regular expression used to test potential terms. Only matching terms are returned. | _string_ (regex) | No (0..1). All terms match by default |
