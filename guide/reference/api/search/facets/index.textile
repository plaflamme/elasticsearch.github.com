...
| _global_ | Set to @true@ to run facet on all documents in the index | No. Default is @false@ |


|| Child || Description || Cardinality ||
| _facet_filter_ | A "@filter@":/guide/reference/search/filter.html to apply to the faceted documents | 0..1 |
| "_terms_":/guide/reference/search/facets/terms-facet.html | A "@terms@":/guide/reference/search/facets/terms-facet.html facet | 0..* |
| range | 
