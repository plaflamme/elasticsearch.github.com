...
h3. facets
|_. Node |_. Desciprion |
| @facets@ | Holds a list of _facet_ definition. Each facet definition node has a unique name that is returned in the query result. |

|_. Child |_. Description |_. Cardinality |
| @<facet-name>@ | A facet to define. It's body is described below. | 1..* |

h3. facet
|_. Node |_. Description |
| @<facet-name>@ | A _facet_ definition. The node name is given by the user. |
...
| @<facet-type>@ | The facet type to define. This is one of: "@terms@":/guide/reference/search/facets/terms-facet.html "@range@":/guide/reference/search/facets/range-facet.html "@histogram@":/guide/reference/search/facets/histogram-facet.html "@date-histogram@":/guide/reference/search/facets/date-histogram-facet.html "@filter@":/guide/reference/search/facets/filter-facet.html "@query@":/guide/reference/search/facets/query-facet.html "@statistical@":/guide/reference/search/facets/statistical-facet.html "@terms-stats@":/guide/reference/search/facets/terms-facet.html "@geo-distance-facet@":/guide/reference/search/facets/geo-distance-facet.html| 1 |
