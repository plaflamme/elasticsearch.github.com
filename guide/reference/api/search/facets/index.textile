...
|_. Child |_. Description |_. Type |_. Required |
| @<facet-type>@ | The facet type to define | One of: "@terms@":/guide/reference/search/facets/terms-facet.html "@range@":/guide/reference/search/facets/range-facet.html "@histogram@":/guide/reference/search/facets/histogram-facet.html "@date-histogram@":/guide/reference/search/facets/date-histogram-facet.html "@filter@":/guide/reference/search/facets/filter-facet.html "@query@":/guide/reference/search/facets/query-facet.html "@statistical@":/guide/reference/search/facets/statistical-facet.html "@terms-stats@":/guide/reference/search/facets/terms-facet.html "@geo-distance-facet@":/guide/reference/search/facets/geo-distance-facet.html| Yes |
| @facet_filter@ | A "@filter@":/guide/reference/search/filter.html to apply to the faceted documents | Any "@filter@":/guide/reference/search/filter.html | No |
| @global@ | Set to @true@ to run facet on all documents in the index | _boolean_ | No. Default is @false@ |
