...
facet-type = (<terms-facet>|<range-facet>|<histogram-facet>|<date-histogram-facet>|<filter-facet>|<query-facet>|<statistical-facet>|<terms-stats-facet>|<geo-distance-facet>)

facet-filter = "facet_filter" : { <filter> }
<pre>

TODO: add links to each facet type and to <filter>