...
facets = "facets" : { <facet-def> (,<facet-def>)* }

facet-def = <facet-name> : { <facet-type> (,"global":true) (,<facet-filter>) }

facet-name = string

facet-type = <facet-type-name> : { <facet-type-body> }

facet-type-name = string

facet-type-body = [see facet-types]

facet-filter = "facet_filter" : { <a href="/guide/reference/api/search/filter.html">"_<filter-def>_"</a> }
<div>